...
const Calendar = () => {
    ...
    return (
      <Box m="20px">
        <Headertop title="Calendar" subtitle="Full Calendar Interactive Page" />
         ...
         {/* CALENDAR RIGHT SIDEBAR */}
          <Box flex="1 1 100%" ml="15px">
            <FullCalendar
              ...
              initialEvents={[{id:"12315",title: "All-day event",date: "2022-09-14",}, {id: "5123",title: "Timed event",date: "2022-09-28",},]}
            />
          </Box>
        </Box>
      </Box>
